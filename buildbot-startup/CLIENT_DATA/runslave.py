...
# - This file is distributed to all slaves.
#   POSIX systems get it through Puppet placed at /usr/local/bin/runslave.py
#   Windows systems through OPSI placed at C:\runslave.py
# - The latest version lives in the 'buildslave' puppet module
# - The OPSI package contains a static import from the puppet-manifests 
#   Revision: 61c0b7a13f40
